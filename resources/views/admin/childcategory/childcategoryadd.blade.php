                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                 ...
                                                 <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <option value="" selected="selected" disabled="disabled">Select subCategory</option>
                                                ...
                                                <option value="sssd">hhh</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="childcategory_name" id="childcategory_name" class="form-control only_character validate[required]" data-errormessage-value-missing="Category is required" data-prompt-position="bottomLeft" placeholder="Enter name" maxlength="200">     
                                                    </div> 
